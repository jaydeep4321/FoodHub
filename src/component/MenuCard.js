                ...
                <div className="w-[33%] md:w-[15%]  flex items-center justify-center ">
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="hidden md:block bg-white shadow hover:bg-orange-600 hover:text-white transition-all font-medium py-1 px-4 rounded absolute bottom-[-15px] left-1/2 transform -translate-x-1/2"
                    >
                      Add
                    </button>
                    ...
                    {/* for mobiles */}
                    <button
                      className="block md:hidden bg-white shadow hover:bg-orange-600 hover:text-white transition-all font-medium text-xs p-1 px-3 rounded absolute bottom-[-8px] left-1/2 transform -translate-x-1/2 "
                      onClick={() => {
                        if (restaurantInfo.length === 0) {
                          dispatch(addToCart(card.info));
                          dispatch(addRestaurantInfo(currentRestaurantInfo));
