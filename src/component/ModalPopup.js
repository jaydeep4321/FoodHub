...
const ModalPopup = ({ setIsOtherRestaurant }) => {
  ...
  return (
    <div
      ...
      className="z-50 fixed inset-0 bg-black bg-opacity-30 backrop-blur-sm flex justify-center items-center"
    >
      <div className="bg-white w-96 p-4 rounded shadow m-2">
        ...
        <div className="grid mt-3 grid-cols-2 gap-4">
          <button
            ...
            className="font-medium hover:shadow-md p-2 bg-orange-200 shadow"
          >
            No
          </button>
          <button
            onClick={clearCartItems}
            className="font-medium hover:shadow-md p-2 bg-orange-700 shadow text-white"
          >
            Yes, Start Fresh
          </button>
        </div>
